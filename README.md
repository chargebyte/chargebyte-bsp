...
| meta-rauc| Layer controlling and performing secure software updates for embedded Linux | https://github.com/chargebyte/meta-rauc |
...
mkdir yocto
cd yocto
repo init -u https://github.com/chargebyte/chargebyte-bsp -b thud
repo sync
```
